          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8" data-testid="seo-issues-section">
            ...
            <div className="space-y-3">
              {report.seo_issues.map((issue, index) => (
                <div
                  key={index}
                  className={`accordion-item border rounded-lg overflow-hidden ${expandedIssue === index ? 'expanded border-indigo-500' : 'border-gray-200'
                    }`}
                >
                  {/* CLICKABLE HEADER */}
                  <button
                      ...
                      {report.linking_analysis.empty_anchor_count > 0 && (
                        <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                          ...
                          <p className="text-2xl font-bold text-red-700">
                            {report.linking_analysis.empty_anchor_count}
                          </p>
                          <p className="text-xs text-red-600 mt-1">Add descriptive anchor text</p>
                              ...
                              <div className="mt-3 border-t border-red-200 pt-3">
                                ...
                                <ul className="space-y-1 max-h-40 overflow-y-auto">
                                  {report.linking_analysis.empty_anchor_links.map((link, idx) => (
                                    <li
                                      key={idx}
                                      className="text-xs text-red-700 bg-white p-2 rounded border border-red-100 break-all"
                                    >
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8" data-testid="content-recommendations-section">
            ...
            <div className="space-y-3">
              {report.content_recommendations.map((rec, index) => (
                <div
                  key={index}
                  className={`accordion-item border rounded-lg overflow-hidden ${expandedSection === `content-${index}` ? 'expanded border-indigo-500' : 'border-gray-200'
                    }`}
                >
                  {/* CLICKABLE HEADER */}
                  <button
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8" data-testid="keyword-density-section">
            ...
            <div className="grid md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-red-500">
                ...
                <p className={`text-lg font-bold ${report.keyword_density_analysis.keyword_stuffing_risk ? 'text-red-700' : 'text-green-700'
                  }`}>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-8" data-testid="page-speed-section">
            ...
            <div className="grid md:grid-cols-4 gap-4 mb-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <p className={`text-2xl font-bold ${(report.page_speed_analysis.render_blocking_scripts || 0) > 3 ? 'text-red-700' : 'text-green-700'
                  }`}>
